        ...
        for name, variable in src.variables.items():
            ...
            if name == input_var:
                ...
                if pe == pe_this_y:  # y=Grid_yのときに変更処理
                    var[Grid_y, 0, Grid_z] *= decrease_rate # (y,x,z)
...
###実行
dirname = f"result/GS/{input_var}*={decrease_rate}_{current_time}"
...
plt.title(f'Grid Search Accumulated PREC (%) Input:{input_var}*={decrease_rate}')
plt.xlabel('Y')
plt.ylabel('Z')
